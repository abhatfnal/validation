...
void demo_ReadHits() {
  ...
  vector<string> filename2 { "/pnfs/uboone/scratch/users/jaz8600/v06_26_01_06/detsyst/deadSaturatedChannels/19363426_203/artroot_output.root" };
...
vector<string> filename5 { "/pnfs/uboone/scratch/users/jaz8600/v06_26_01_06/detsyst/altDeadChannels/22731397_52/artroot_output.root" };
 ...
 // chain->Add("/pnfs/uboone/scratch/users/jaz8600/v06_26_01_06/detsyst/CV/*/artroot_output.root");
  ...
  for (gallery::Event ev(filename2) ; !ev.atEnd(); ev.next()) {
    ...
    THStack *hs2= new THStack("hs2","Hits per Channel Residue");    
  ...
  h_hit_residue1->Add(h_hit_hitsperchannel2,-1.0);
    ...
    hs2->Add(h_hit_residue1);
    //  hs2->Add(h_hit_residue2);
    //   hs2->Add(h_hit_residue3);
    hs2->Add(h_hit_residue4);
  ...
  auto legend = new TLegend(0.1,0.7,0.48,0.9);
   ...
   // h_hit_residue1->SetLineColor(kBlue);
    ...
    // h_hit_residue3->Draw("SAME");
     //     h_hit_residue4->GetHistogram()->SetMinimum(-8.);
    // h_hit_residue4->Draw("SAME");
    hs2->Draw();
    hs2->GetXaxis()->SetTitle("Channel Number");
    hs2->GetYaxis()->SetTitle("(CV-Syst)");
    canvas->Modified();    
